#include "ViewerControlChannel.h"

bool ViewerControlChannel::SendMessage(SOCKET sock, const Protocol::ControlMessage& msg) {
...
std::optional<Protocol::ControlMessage> ViewerControlChannel::ReceiveMessage(SOCKET sock, int timeoutMs) {
